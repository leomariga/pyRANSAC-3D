...
- [x] #7 Add generators of numpy point cloud to make tests and examples. 
- [x] #17 Add additional output information
...
- [x] #34 Add callbacks
- [x] Create a folder with examples and add to the documentation.
- [x] Create a folder with formal pytest tests and run it with the tasks.py
