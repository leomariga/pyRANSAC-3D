...
2. Create the shape fitter.
3. Call `.fit(points, thresh=...)`.
4. Use the fitted parameters and the inlier indexes.
...
- Open the API pages for each fitter: [Plane](api-documentation/plane.md), [Sphere](api-documentation/sphere.md), [Cylinder](api-documentation/cylinder.md), [Cuboid](api-documentation/cuboid.md), [Line](api-documentation/line.md), [Circle](api-documentation/circle.md), and [Point](api-documentation/point.md).
